...
ADD https://api.github.com/repos/marcosav/Valetudo/git/refs/heads/master /usr/src/version.json

# Download valetudo
RUN git clone --depth 1 https://github.com/marcosav/Valetudo --single-branch .
